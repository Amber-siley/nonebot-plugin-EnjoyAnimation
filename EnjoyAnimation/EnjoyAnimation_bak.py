...
animation_config=get_driver().configh
...
class json_files:
    def __init__(self,json_path) -> None:
        ...
        '''json文件路径'''
    def read(self):
        with open(self.__json_path,"r",encoding="utf-8") as r:
            return json.load(r)
    def write(self,data):
        with open(self.__json_path,"w",encoding="utf-8") as w:
